...
1.  Les modèles de régression
    ...
    1.  Régression linéaire (Régression)

    2.  Régression logistique (Classification)

2.  Les modèles à base d'arbre

    1.  Arbre de décision (Régression et classification)

    2.  Forêt aléatoire (Régression et classification)

    3.  XGBoost (Régression et classification)
