...
-   Ces algorithmes (très nombreux!) pour les deux types d'apprentissage ([classification]{style="color:blue"} et [régression]{style="color:red"}).
...
::: notes
Les algorithmes sont plus ou moins bien adaptés aux données en entrée. Certains algorithmes sont plus gourmands en ressources informatiques que d'autres. Par exemple, les forêts aléatoires sont gourmands en ressources informatiques, bien davantage que les régréssions.
...
::: notes
En machine learning, la performance d'un modèle est sa capacité à prédire sur des données qu'il n'a jamais vues.
:::
...
::: notes
Exactitude : 1 mal classé sur 3 (33,33%)
...
## La quête du Saint Graal {.smaller}
...
1.  Et si on retirait une variable ?
