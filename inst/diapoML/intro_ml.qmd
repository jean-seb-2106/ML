...
# Etape 5 : Evaluation de la performance des modèles
...
# Etape 6 : Choix du modèle et généralisation
...
kbl(pred_modele_final)
```

# Deuxième exemple : classification supervisée
...
mutate(Y_PAUVRE = as.factor(Y_PAUVRE))

kbl(head(grandile))

```

# Etape 2 : Explorer, nettoyer et améliorer la base {.scrollable}
...
## Modèle 1 : la régression logistique

## Modèle 2 : l'arbre de classification

## Modèle 3 : la forêt aléatoire
