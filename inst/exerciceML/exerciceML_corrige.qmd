...
### Ajuster ce modèle sur la base d'entraînement et de validation puis généraliser le sur des données qu'il n'a jamais vu (les données de test). Que peut-on conclure ?
