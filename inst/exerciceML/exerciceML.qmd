...
La base de données brute "vins" est constituées de `r nrow(vins)` individus : ces individus sont des références de vins qui ont été goûtés et notés par des professionels. Ils sont caractérisés par une note et leur composition chimique.
